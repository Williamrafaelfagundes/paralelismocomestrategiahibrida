...
#define NUM_PORTFOLIOS 1000000 // Apenas 1 milhão de simulações para manter o tempo de execução razoável na CPU
...
int main() {
    ...
    printf("\nTempo Total de Execução (CPU Sequencial): %.4f segundos.\n", cpu_time_used);
